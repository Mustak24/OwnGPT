...
var chunkMARKQMKP_js = require('../chunk-MARKQMKP.js');
require('../chunk-Q6G2DVU3.js');
require('../chunk-EFPA3LTE.js');
...
function PermissionModal({ permission, requestPermission, onDeny, permissionStatus, description, renderModalUI, ...props }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    chunkMARKQMKP_js.CenterModal,
    {
      ...props,
      preventCloseRequest: true,
      style: { borderRadius: 20, padding: 8 },
      children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: { gap: 24 }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: { alignItems: "center", width: "100%", gap: 8 }, children: [
          /* @__PURE__ */ jsxRuntime.jsx(chunkMARKQMKP_js.ThemeText, { style: { fontSize: 24, fontWeight: "600" }, children: "Permission Required" }),
          /* @__PURE__ */ jsxRuntime.jsx(chunkMARKQMKP_js.ThemeText, { color: "text-secondary", style: { fontSize: 16, textAlign: "center", paddingHorizontal: 8 }, children: description ?? info.description })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: { flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "flex-end", width: "100%" }, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            chunkMARKQMKP_js.Button,
            {
              color: "primary",
              variant: "solid",
              title: permissionStatus === reactNative.PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN ? "Settings" : "Allow",
...
function usePermission({ permission, autoRequest = false, onDeny, onGrant, modalDescription, renderModalUI }) {
  ...
  const [permissionStatus, setPermissionStatus] = react.useState(reactNative.PermissionsAndroid.RESULTS.DENIED);
  async function requestPermission() {
    if (reactNative.Platform.OS !== "android") return;
    try {
      const result = await reactNative.PermissionsAndroid.request(permission);
  ...
  function handlePermission(result) {
    switch (result) {
      case reactNative.PermissionsAndroid.RESULTS.GRANTED:
        onGrant?.();
        return setIsModalVisible(false);
      case reactNative.PermissionsAndroid.RESULTS.DENIED:
        return setIsModalVisible(true);
      case reactNative.PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN:
        return isModalVisible ? reactNative.Linking.openSettings() : setIsModalVisible(true);
    }
  }
  function Modal() {
    function handleDeny() {
